...
<html lang="en">
<head>
<title>5haled-store</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="5haled-store shop project">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="/frontend/images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">{{ $setting->email }}</a></div>
...
{{--                                @else--}}
{{--                                 <a href="{{ route('language.hindi') }}">Arabic<i class="fas fa-chevron-down"></i></a>--}}
{{--                                @endif--}}
...
{{--                                    </li>--}}
                         ...
                         @guest
                <div><a href="{{ route('login') }}"><div class="user_icon"><img src="/frontend/images/user.svg" alt=""></div> Register/Login</a></div>
                         @else
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}"><img src="/frontend/images/logo.png" alt=""></a></div>
                        </div>
                    </div>
...
<!--Order Traking Modal -->
<div class="modal fade" style="z-index: 2147483647;" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
