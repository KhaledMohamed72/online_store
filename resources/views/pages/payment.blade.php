...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
    ...
    <div class="form-group">
        <ul class="logos_list">
            <li><input type="radio" name="payment" value="stripe"><img src="/frontend/images/mastercard.png" style="width: 100px; height: 60px;"> </li>

             <li><input type="radio" name="payment" value="paypal"><img src="/frontend/images/paypal.png" style="width: 100px; height: 60px;"> </li>

              <li><input type="radio" name="payment" value="ideal"><img src="/frontend/images/mollie.png" style="width: 100px; height: 60px;"> </li>
